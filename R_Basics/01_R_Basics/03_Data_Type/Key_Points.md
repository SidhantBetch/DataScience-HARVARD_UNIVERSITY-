...
- The function levels() can be used to determine the levels of a factor. R will store those levels as integers and will keep a map to keep track of the levels. The function nlevels() can determine the number of factors.
